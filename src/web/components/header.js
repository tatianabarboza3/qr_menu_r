            ...
            <header className={props.otherClass === true ? "otherPage" : ""}>
                <nav>
                    <div className="navBox">
                        <Link to="/">
                            ...
                            <svg className="logo" version="1.1" id="Layer_1"
                                 xmlns="http://www.w3.org/2000/svg"
                                 xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                 viewBox="0 0 307 126.5" style={{"enableBackground" : "new 0 0 307 126.5"}}
                                 xmlSpace="preserve">
                            <g>
                                <g id="_x33_Xy4la.tif_2_">
                                    <g id="path_01">
                                        ...
                                        <path
                                            d="M34.5,94.8c0,2.7-2.2,4.7-4.8,4.7c-2.7,0-4.8-2.1-4.8-4.7c0-2.6,2.1-4.7,4.8-4.7C32.4,90.1,34.6,92.2,34.5,94.8z"/>
                                        <path
                                            d="M29.8,37c-2.7,0-4.8-2-4.8-4.7c0-2.6,2.1-4.7,4.7-4.7c2.6,0,4.8,2,4.8,4.7C34.5,34.9,32.4,37,29.8,37z"/>
                                        <path
                                            d="M93.8,37C91.3,37,89,34.8,89,32.3c0-2.6,2.3-4.7,4.9-4.7c2.6,0,4.8,2.3,4.8,4.7C98.6,34.6,96.5,37.1,93.8,37z"/>
                                    </g>
                                </g>
                                <g id="path_01">
                        ...
                        <div className="menu-sm" id="menu-sm" onClick={handleMenuSmClick}> <img src={menu} alt="menu" /></div>
                        <div className="cross" id="cross" onClick={handleCrossClick}><img src={clear} alt="" /></div>
                    </div>
                    <ul id="menu">
                ...
                <div className="headerBox">
                    <div className="headerContent animate__animated animate__bounceIn">
                        <h1>Virtual Menú</h1>
                        <h4>Digitalizamos el menú de su negocio y creamos un Código QR que permite a sus clientes leer la carta
                            en sus dispositivos personales.</h4>
                    </div>
                </div>
            </header>
        </>

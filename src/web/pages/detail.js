    ...
    <>
      ...
      <section className="detail-01">
        ...
        <div className="detail-content">
          <p>
            Coloque en las mesas o puntos de interés un porta código y ofrezca
            visualizar el menú sin tener contacto con la carta simplemente
      ...
      <section className="detail-02">
        <div className="detail-content">
          <p>
            Ahorre tiempo a sus camareros, clientes y lo más importante...
            cuidar de todas las personas relacionadas a su negocio ahora está a
            su alcance.
          </p>
          <p>
            Las cartas dejarán de ser vectores de contagio y no será necesario
